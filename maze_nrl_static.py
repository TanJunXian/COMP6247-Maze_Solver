...
class MazeRunner():
    ...
    def map(self,around):
        ...
        self.world[row-1,col-1][0] = around[0][0][0]
        self.world[row-1,col][0]   = around[0][1][0]
        self.world[row-1,col+1][0] = around[0][2][0]
        self.world[row,col-1][0]   = around[1][0][0]
        self.world[row,col][0]     = around[1][1][0]
        self.world[row,col+1][0]   = around[1][2][0]
        self.world[row+1,col-1][0] = around[2][0][0]
        self.world[row+1,col][0]   = around[2][1][0]
        self.world[row+1,col+1][0] = around[2][2][0]
    ...
    def plot(self):
            ...
            cmap = colors.ListedColormap(['black','white','tan', 'deepskyblue','gold','grey'])
